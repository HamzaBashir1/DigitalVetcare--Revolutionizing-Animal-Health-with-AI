    ...
    <>
     ...
     <section className='hero_section pt-[60px] 2xl:h-[800px]'>
      <div className='container'>
        ...
        <div>
          ...
          {/* Hero counter */}
          <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
            <div>
     ...
     <setion>
      <div className='container'>
        ...
        <div className='flex flex-wrap items-center justify-between flex-col md:flex-row gap-5 lg:gap-[30px]'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[3opx] mt-[30px] lg:mt-[55px]'>
          ...
          <div className='mt-[30px]'>
            ...
            world-class care for everyone. Our health System offers unmatched,
            expert heath care.From lathe lab to the clinic.</p>
     ...
     <section>
      <div className='container'>
        ...
        <p className='text_para'>world-class care for everyone. Our health System offers unmatched,
            expert heath care.</p>
        </div>
